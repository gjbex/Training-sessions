...
graph TD
  ...
  click Generative_ai_for_software_engineering_and_data_analysis "generative_ai_for_software_engineering_and_data_analysis.md" "Generative AI for software engineering and data analysis"
  click Scientific_visualization_with_ParaView "scientific_visualization_with_paraview.md" "Scientific visualization with ParaView"

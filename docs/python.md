...
graph TD
  ...
  Python_for_programmers --> Machine_learning_with_Python[Machine learning with Python]
  Python_for_data_science --> Machine_learning_with_Python
  Python_for_data_science --> Python_dashboards[Python dashboards]
  Machine_learning_with_Python --> Python_dashboards
  Scientific_Python --> Python_for_HPC[Python for HPC]
  Scientific_Python --> Python_on_GPUs[Python on GPUs]
